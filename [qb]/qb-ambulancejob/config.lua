...
Config.BillCost = 1                                       -- Price that players are charged for using the hospital check-in system
Config.DeathTime = 15                                       -- How long the timer is for players to bleed out completely and respawn at the hospital
Config.ReviveInterval = 15                                  -- How long the timer is for players to revive a player in laststand
