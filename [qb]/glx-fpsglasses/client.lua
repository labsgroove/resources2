...
RegisterNetEvent('glx-glasses:client:applyfpsboos', function(args)
	...
	if args == 1 then
        ...
        QBCore.Functions.Notify('Fps boost aplicado')
    else
        ...
        QBCore.Functions.Notify('Fps boost removido')
    end
end)

RegisterNetEvent('glx-glasses:client:useGlasses', function()
    local ped = PlayerPedId()
    QBCore.Functions.Progressbar("glasses", "Colocando óculos FPS", 1000, false, true, {
