...
QBConfig.Money = {}
QBConfig.Money.MoneyTypes = { cash = 5000000, bank = 420, crypto = 0 } -- type = startamount - Add or remove money types for your server (for ex. blackmoney = 0), remember once added it will not be removed from the database!
...
QBConfig.Player = {}
QBConfig.Player.HungerRate = 1.2 -- Rate at which hunger goes down.
