...
RegisterNetEvent('mt-clothingbag:client:openBag', function()
    QBCore.Functions.Progressbar('name_here', 'Colocando bolsa no chão', 2000, false, true, {
...
RegisterNetEvent('mt-clothingbag:client:openBag2', function(obj)
    QBCore.Functions.Progressbar('name_here', 'Abrindo bolsa', 5000, false, true, {
        disableMovement = true,
        disableCarMovement = true,
        disableMouse = false,
        disableCombat = true,
...
RegisterNetEvent('mt-clothingbag:client:progressDespawnBag', function(obj)
    QBCore.Functions.Progressbar('taking_cloth', 'Pegando roupas da bolsa', 2000, false, true, {
        disableMovement = true,
        disableCarMovement = true,
        disableMouse = false,
        disableCombat = true,
        ...
        QBCore.Functions.Progressbar('picking_bag', 'Guardando a bolsa', 2000, false, true, {
            disableMovement = true,
            disableCarMovement = true,
            disableMouse = false,
            disableCombat = true,
