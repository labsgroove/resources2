...
Shared.CastTimeMax = 15 -- Maximum Time in seconds between fishing and minigame
...
Shared.MinigameTime = 15 -- Minigame: Amount of time in seconds

Shared.SellLocation = vector4(-1830.5872, -1180.8125, 19.1686, 327.0873)
...
Shared.FishingZones = {
    ...
    coords = vector3(-1608.16, 5253.48, 3.97),
    heading = 22,
    length = 50.4,
    width = 50.0,
    minZ = 0.01,
    ...
    [3] = {
    coords = vector3(-2973.1125, -177.4953, 4.8085),
    heading = 178.75,
    length = 50.4,
    width = 50.0,
    minZ = 0.01,
    ...
    [4] = {
        coords = vector3(-1846.1335, -1253.8889, 8.6158),
        heading = 148.75,
        length = 50.4,
        width = 50.0,
        minZ = 0.01,
    ...
    [5] = {
        coords = vector3(-2051.2078, -1458.3579, 1.2660),
        heading = 135.35,
        length = 300.4,
        width = 300.0,
        minZ = 0.01,
    ...
    [6] = { -- Example of a PolyZone (box = false)
        points = {
