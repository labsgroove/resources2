...
local handleMods = {
    ...
    {"fLowSpeedTractionLossMult", 1.51}
}
...
AddEventHandler('m-Drift:Client:Ativar', function()
    ...
    if not IsPedSittingInAnyVehicle(playerPed) then return QBCore.Functions.Notify("Precisa estar dentro do carro.", "error") end
    ToggleDrift()
end)
...
function ToggleDrift(vehicle)
    ...
    if driftMode then
        ...
        disableCombat = true}, {}, {}, {}, function() end) Wait(5000) QBCore.Functions.Notify("Drift desligado!")
    else
        ...
        disableCombat = true}, {}, {}, {}, function() end) Wait(5000) QBCore.Functions.Notify("Drift LIGADO!")
    end
end
