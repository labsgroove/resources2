...
Config.Teleports = {
    ...
    [3] = { --pvp
        [1] = {
            poly = { coords = vector3(316.6101, -588.1144, 43.2918 ), heading = 3.8135, length = 2, width = 2 },
            allowVeh = false,
            label = 'Sair'
        },
        [2] = {
            poly = { coords = vector3(-218.5553, -58.7123, 2112.8811 ), heading = 165.2324, length = 2, width = 2 },
            allowVeh = false,
            label = 'PVP'
        }
    },
    [4] = { --exe
        [1] = {
            poly = { coords = vector3(-2360.8904, 3249.2300, 92.9038 ), heading = 330.8923, length = 2, width = 2 },
            allowVeh = false,
            label = 'Elevador'
        },
        [2] = {
            poly = { coords = vector3(-2360.8396, 3249.3191, 32.8107 ), heading = 327.3842, length = 2, width = 2 },
            allowVeh = false,
            label = 'Elevador'
        }
    },
    [5] = { --cayoo
        [1] = {
            poly = { coords = vector3(5903.2305, -4929.8608, 179.3895), heading = 330.8923, length = 2, width = 2 },
            allowVeh = false,
            label = 'Praça'
        },
        [2] = {
            poly = { coords = vector3(155.8361, -972.5173, 30.0919), heading = 327.3842, length = 2, width = 2 },
            allowVeh = false,
            label = 'Cayo Perico'
        }
    }
