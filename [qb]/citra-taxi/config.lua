...
Config.MinSpawnDist = 2.0 -- Min distance that a taxi will spawn from the player (in-game units)
...
Config.Fare = {
    ...
    tick = 1.0, -- How much to charge per tick
    tickTime = 60 * 1000, -- How often to charge the tick rate (ie $0.25 per 30s)
}

Config.DriverModel = 'u_m_y_party_01' -- Driver model name
