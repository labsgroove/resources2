            ...
            local options = {
                {
                    ...
                    onSelect = function()
                        -- Atribuir a gangue da crew ao jogador no servidor
                        TriggerServerEvent('angelicxs-NPCCrew:Server:SetPlayerGang', info.crew)
                        TriggerEvent('angelicxs-NPCCrew:CategoryMenu', info, options)
                    end,
                    canInteract = function(entity)
                        return true -- Permitir interação independentemente da gangue
                    end,
                },
            }
