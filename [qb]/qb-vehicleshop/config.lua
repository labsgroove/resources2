    ...
    ['pdm'] = {
        ...
        ['ShowroomVehicles'] = {
            [1] = {
                ...
                defaultVehicle = 'tr22',                       -- Default display vehicle
                chosenVehicle = 'tr22',                        -- Same as default but is dynamically changed when swapping vehicles
            },
            [2] = {
                coords = vector4(-48.27, -1101.86, 25.44, 294.5),
                defaultVehicle = 'golfgti7',
                chosenVehicle = 'golfgti7'
            },
            [3] = {
    ...
    ['luxury'] = {
        ...
        ['ShowroomVehicles'] = {
            ...
            [5] = {
                ...
                defaultVehicle = 'wmfenyr',
                chosenVehicle = 'wmfenyr'
            },
            [6] = {
