...
Config.Cooldown               = 5000           -- Default 25000, A cooldown, (5mins) this is so players can't spam it.
Config.AutoCallAmbulance      = true             -- Default true, if true, it calls the ambulance automatically for you.
Config.AutoCallTimer          = 10000            -- Default 20000, A timer to call ambulance automatically after 20secs.
...
Config.UsePoliceAssist        = true            -- if true, a police player can let a police ped drive the player to the HQ
Config.UseAutoJail            = true            -- Default false, if you dont have police you can set this true
...
Config.Service = {                           
    ['ambulance'] = {
        ...
        price       = 500,                                   -- cost..
        spawnRadius = 100,                                   -- spawn Radius around the player
