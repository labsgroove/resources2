...
config.drivingStyle = {
    ...
    [3] = true, -- Avoid vehicles
    [4] = true, -- Avoid empty vehicles
    [5] = true, -- Avoid peds
    [6] = true, -- Avoid objects
    [7] = false, -- Unknown
    [8] = false, -- Stop at traffic lights
    [9] = true, -- Use blinkers
...
config.restrictVehicles = false -- will restrict usage of self driving onlu to allowed vehicles listed below
